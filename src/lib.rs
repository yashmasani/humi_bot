...
mod tests {
    ...
    fn test_away_from() {
        ...
        let expect = vec![TimeOffDescription { name: "Long TestMan is away".to_string(), time_away: "Away from Apr 30 to May 07".to_string() }, TimeOffDescription { name: "Colin Moore is away".to_string(), time_away: "Away for 1.00 day".to_string() }, TimeOffDescription { name: "Tset Dome is away".to_string(), time_away: "Away for 1.00 day".to_string() }];
